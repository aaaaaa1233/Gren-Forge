...
// im copying whatever the bren-reforged fork did because i have NO idea what iz hpapenig
public class SoundReg {
    ...
    public static SoundEvent ITEM_PISTOL_SHOOT = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID, "item.pistol.shoot"));
    ...
    public static SoundEvent ITEM_SMG_SHOOT = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID,"item.smg.shoot"));
    public static SoundEvent ITEM_HEAVY_MG_SHOOT = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID,"item.heavy_mg.shoot"));
    public static SoundEvent ITEM_HEAVY_RIFLE_SHOOT = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID,"item.heavy_rifle.shoot"));
    public static SoundEvent ITEM_HEAVY_RIFLE_RACK = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID,"item.heavy_rifle.rack"));
    public static SoundEvent ITEM_HEAVY_RIFLE_INSERT = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID,"item.heavy_rifle.insert"));
    public static SoundEvent ITEM_DB_SHOTGUN_SHOOT = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID,"item.db_shotgun.shoot"));
    public static SoundEvent ITEM_DB_SHOTGUN_RELOAD = SoundEvent.createVariableRangeEvent(
            new ResourceLocation(Bren.MODID,"item.db_shotgun.reload"));
    ...
    public static SoundEvent ENTITY_VILLAGER_WORK_GUNSMITH = SoundEvent.createVariableRangeEvent(new ResourceLocation("entity.villager.work_gunsmith"));
